...
const ContactUs = () => {
  ...
  return (
    <><Head>
     <title>Recycle Radar- ContactUs</title> </Head><div className="px-4 w-full py-16 lg:py-24 md:pb-32 md:container">
      <ToastContainer
        className="text-2xl"
        position="top-right"
        autoClose={3000}
            ...
            <ul className="footer footer-list">
              ...
              <li className="footer-item">
                ...
                <Link
                  target="_blank"
                  rel="noopener noreferrer"
                  href="mailto:contact@Recycle Radar.com"
                  className="contact-link"
                >
                  contact@Recycle Radar.com
                </Link>
              </li>
              <li className="footer-item">
