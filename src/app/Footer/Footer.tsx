    ...
    <footer className="footer projects shadow-2xl">
      ...
      />
        <div className="container">
          <div className="footer-brand">
            ...
            Recycle Radar: Transforming E-Waste Management. Find E-waste facilities effortlessly with our platform. Your key to responsible recycling and sustainability.
            </p>
          ...
          <ul className="footer-list">
            ...
            <li className="footer-item">
              ...
              <Link
                target="_blank"
                rel="noopener noreferrer"
                href="mailto:contact@recycleradar.com"
                className="contact-link"
              >
                contact@recycleradar.com{" "}
              </Link>
            </li>
            <li className="footer-item">
      ...
      <div className="footer-bottom">
        ...
        <p className="copyright">
            &copy; 2024 Recycle Radar | All Rights Reserved by{" "}
